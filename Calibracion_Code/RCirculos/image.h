...
#include <opencv/highgui.h> // inclui--> #include<opencv/hi..>
#include <QImage>
...
///
inline QImage convertMatToQimage(Mat input)
{
...
///
inline Mat convertQImageToMat( const QImage &inImage, bool inCloneImageData = true )
{
    Mat out;
